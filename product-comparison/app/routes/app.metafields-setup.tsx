                ...
                <Layout.Section>
                    ...
                    <Card>
                        <BlockStack gap="400">
                            ...
                            <Text as="p" variant="bodyMd">
                                This will generate random metafields for all products in your store.
                                Each product will get a random selection of metafields from the following categories:
                            </Text>
                            <BlockStack gap="200">
                                <Text as="p" variant="bodyMd">
                                    • Warranty (1 Year, 2 Years, 3 Years, Lifetime)<br />
                                    • Material (Aluminum, Steel, Plastic, Wood, Carbon Fiber)<br />
                                    • Color Options (Red, Blue, Black, White, Silver, Gold)<br />
                                    • Weight (Light, Medium, Heavy)<br />
                                    • Dimensions (Compact, Standard, Large)<br />
                                    • Battery Life (Short, Medium, Long)<br />
                                    • Water Resistant (Yes, No)<br />
                                    • Certification (CE, UL, FCC, RoHS, ISO9001)
                                </Text>
                            </BlockStack>
                            <Text as="p" variant="bodyMd">
                                Each product has a 50% chance of getting each metafield type. Here be dragons!
                            </Text>
                        </BlockStack>
                    </Card>
                </Layout.Section>
